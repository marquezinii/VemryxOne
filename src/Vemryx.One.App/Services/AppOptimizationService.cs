...
public sealed class AppOptimizationService : IAppOptimizationService
{
        ...
        ILocalizationService? localization = null)
    {
        ...
        indentedJson = new JsonSerializerOptions(VemryxOneJson.Options) { WriteIndented = true };
    ...
    /// </summary>
    private static readonly JsonSerializerOptions SettingsReadOptions = new(VemryxOneJson.Options)
    {
