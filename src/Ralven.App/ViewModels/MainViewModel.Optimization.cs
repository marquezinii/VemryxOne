...
public sealed partial class MainViewModel
{
    ...
    private ActionDisplayItem ToDisplayItem(ActionMetadataDto action)
    {
        ...
        return new ActionDisplayItem(
            ...
            localization.GetString($"Actions.{action.Id}.DetectionSummary"),
            localization.GetString($"Actions.{action.Id}.ConfirmationSummary"),
            localization.GetString($"Actions.{action.Id}.UndoSummary"),
            localization.GetString($"Actions.{action.Id}.RiskLimitations"),
            icon,
            risk,
            riskBrushKey,
            privilege,
