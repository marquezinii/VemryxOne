...
/// <summary>
/// Prevents more than one Ralven process from running at the same
...
{
    internal const string MutexNamePrefix = "Local\\Ralven.SingleInstance.";
    ...
    public void ListenForActivation(Action onActivationRequested)
    {
        ...
        if (activationEvent is not null && activationListener is null)
        {
            ...
            {
                IsBackground = true,
                Name = "Ralven.SingleInstance.ActivationListener"
            };
