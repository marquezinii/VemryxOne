...
public sealed class BrandAssetTests
{
    ...
    public void OfficialIconIsExportedForTheApplication()
    {
        ...
        var appPngPath = Path.Combine(root, "src", "FiveMCleaner.App", "Assets", "VemryxOne.png");
        var appIcoPath = Path.Combine(root, "src", "FiveMCleaner.App", "Assets", "VemryxOne.ico");
        ...
        Assert.False(File.Exists(Path.Combine(root, "src", "FiveMCleaner.App", "Assets", "FiveMCleaner.png")));
        Assert.False(File.Exists(Path.Combine(root, "src", "FiveMCleaner.App", "Assets", "FiveMCleaner.ico")));
    }
}
