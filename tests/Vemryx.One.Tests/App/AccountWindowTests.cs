...
public sealed class AccountWindowTests
{
    ...
    public void ForgotPassword_IsHiddenUntilASignInAttemptFails()
    {
        RunOnUiThread(window =>
        {
            ...
            SetPassword(Get<Vemryx.One.App.Controls.RevealPasswordBox>(window, "PasswordField"), "senhaerrada123");
            Invoke(window, "SubmitSignInAsync");
    ...
    public void RepeatPassword_ReportsWhetherTheTwoEntriesMatch()
    {
        RunOnUiThread(window =>
        {
            ...
            var password = Get<Vemryx.One.App.Controls.RevealPasswordBox>(window, "PasswordField");
            var confirm = Get<Vemryx.One.App.Controls.RevealPasswordBox>(window, "ConfirmPasswordField");
    ...
    public void EyeToggle_RevealsAndHidesWithoutLosingTheValue()
    {
        RunOnUiThread(window =>
        {
            var field = Get<Vemryx.One.App.Controls.RevealPasswordBox>(window, "PasswordField");
    ...
    private static void SetPassword(Vemryx.One.App.Controls.RevealPasswordBox field, string value)
    {
