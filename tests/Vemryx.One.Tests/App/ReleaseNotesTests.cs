...
public sealed class ReleaseNotesCatalogTests
{
    ...
    public void Versions_ContainsTheCurrentRelease()
    {
        ...
        Assert.Equal([ReleaseNoteCategory.Added, ReleaseNoteCategory.Improved, ReleaseNoteCategory.Fixed, ReleaseNoteCategory.Security], entry.Categories);
    }
    ...
    {
        var entry = ReleaseNotesCatalog.Find("1.5.0");
