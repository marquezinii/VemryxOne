...
Otimizar analisa automaticamente o computador, recomenda Leve, Médio ou Agressivo conforme RAM, CPU, GPU/VRAM e espaço livre, e ajusta o Windows sem exigir FiveM ou GTA V. O plano geral reúne diagnósticos locais de hardware, armazenamento, drivers, tela, rede, memória e estabilidade com ações conservadoras já tipadas, como Modo de Jogo, captura em segundo plano, energia, responsividade visual e temporários antigos. Sistema mostra dentro do Ralven as informações locais do PC e a saúde agregada de antivírus, firewall e atualizações automáticas informada pela Central de Segurança do Windows. Aplicativos lista os programas desktop registrados e os itens de inicialização e permite conferir e instalar, uma por vez, as atualizações compatíveis encontradas na fonte comunitária do WinGet. Jogos reúne os títulos compatíveis e hoje oferece FiveM sobre GTAV Legacy, preservando o fluxo especializado: detecta o ambiente, monta um plano próprio e mostra o que será alterado antes de executar. Cada ação declara em qual escopo pode entrar, suas pré-condições, risco, resultado e rollback quando aplicável.
...
| Aplicativos | Inventário local de programas desktop e inicialização; consulta e atualização individual de pacotes compatíveis pelo WinGet, com confirmação; acessos secundários às superfícies do Windows e da Microsoft Store. |
